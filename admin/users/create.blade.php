            ...
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg p-6">
                <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-6" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="faculty_id" name="faculty_id" type="text" class="block w-full mt-1" />
                    ...
                    <div class="flex justify-between items-center mt-6">
                        <div class="flex space-x-4">
                            <a href="{{ route('admin.users.index') }}" class="bg-red-500 hover:bg-red-600 text-white font-semibold py-2 px-4 rounded-md">
                                {{ __('Cancel') }}
                            </a>
